    ...
    <main className="min-h-screen">
      ...
      <div className="pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          <Breadcrumbs items={[{ label: "All Examinations" }]} />
          ...
          <div className="space-y-6 mb-16 max-w-3xl">
            <h1 className="text-5xl lg:text-7xl font-headline font-bold leading-[1.1] tracking-tight uppercase">
              Unified <span className="gradient-text">Preparation</span>
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Access India's most comprehensive collection of mock tests and previous year questions. 
              Search for any exam to start your success journey.
            </p>
          </div>
            ...
            <div className="flex-1 space-y-12">
              <div className="flex flex-col sm:flex-row gap-4 items-center p-4 glass border-white/10 rounded-2xl">
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                  <button className="flex items-center gap-2 px-6 py-2 rounded-xl bg-white/5 border border-white/10 text-xs font-bold hover:bg-white/10 transition-colors h-12">
              ...
              {examsLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  {filteredExams.length === 0 && (
                    <div className="col-span-full py-20 text-center text-muted-foreground glass border-white/5 rounded-[3rem] space-y-4">
                       <BookOpen className="w-12 h-12 mx-auto opacity-10" />
                       <p className="font-bold tracking-widest uppercase text-xs">No matching examinations found</p>
                    </div>
                  )}
                </div>
              )}
