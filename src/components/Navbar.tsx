        ...
        <div className="container mx-auto flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-2 md:gap-4">
            ...
            >
              ...
              <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-slate-900 text-[10px] px-2 py-1 rounded border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                Search (⌘K)
              </span>
            </Button>
            ...
            {loading ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 glass border-white/10" align="end">
                  ...
                  <DropdownMenuItem className="focus:bg-white/5 cursor-pointer" onClick={() => router.push('/admin')}>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden fixed inset-x-4 top-20 z-[101] glass border border-white/10 p-6 rounded-3xl flex flex-col gap-4 animate-in slide-in-from-top-4 fade-in duration-300">
            ...
            <div className="flex flex-col gap-3 pt-4">
              {user ? (
                <>
                  <Button variant="outline" className="w-full h-12 rounded-xl border-white/10" onClick={() => { setIsMobileMenuOpen(false); router.push('/admin'); }}>
                    Dashboard
                  </Button>
